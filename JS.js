...
document.getElementById("baixarModulo").addEventListener("click", function() {
    // Coloque aqui a lógica para baixar o módulo
    // Exemplo: window.location.href = "link_do_modulo.pdf";
});
